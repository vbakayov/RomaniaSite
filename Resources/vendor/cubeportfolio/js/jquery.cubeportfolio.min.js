...
gridAdjustment:"responsive",/**
     ...
     */
mediaQueries: [{width: 1440, cols: 5}, {width: 1024, cols: 4}, {width: 768, cols: 3}, {width: 480, cols: 2}, {width: 320, cols: 1}] ,/**
...
// filter the items
c.$obj.cubeportfolio("filter",g)}})})},e.prototype.filtersCallback=function(b,c){a.isEmptyObject(b)||(b.wrap.trigger("mouseleave.cbp"),b.headerText?b.headerText="":b.header.html(c.html())), jQuery('.cbp-filter-item').removeClass("cbp-filter-item-active"),c.addClass("cbp-filter-item-active"),jQuery('#all').removeClass('cbp-filter-item-active');},/**
